...
print(f"DEBUG_SETTINGS: DJANGO_DEBUG from env: '{os.environ.get('DEBUG')}'")
...
print(f"DEBUG_SETTINGS: DJANGO_ALLOWED_HOSTS from env: '{os.environ.get('ALLOWED_HOSTS')}'")
...
print(f"DEBUG_SETTINGS: DJANGO_CSRF_TRUSTED_ORIGINS from env: '{os.environ.get('CSRF_TRUSTED_ORIGINS')}'")
...
print(f"DEBUG_SETTINGS: DJANGO_SECURE_SSL_REDIRECT from env: '{os.environ.get('DJANGO_SECURE_SSL_REDIRECT')}'")
print(f"DEBUG_SETTINGS: Actual SECURE_SSL_REDIRECT value: {SECURE_SSL_REDIRECT}")
